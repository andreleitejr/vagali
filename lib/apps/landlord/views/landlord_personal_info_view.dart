...
class LandlordPersonalInfoView extends StatefulWidget {
  LandlordPersonalInfoView({super.key});

  @override
  State<LandlordPersonalInfoView> createState() =>
      _LandlordPersonalInfoViewState();
}

class _LandlordPersonalInfoViewState extends State<LandlordPersonalInfoView> {
  late LandlordEditController controller;

  @override
  void initState() {
    controller = Get.put(LandlordEditController());
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: LandlordPersonalInfoWidget(controller: controller),
      ),
    );
  }
}
